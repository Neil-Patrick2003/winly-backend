...
class IndexPostLikeRequest extends FormRequest
{
     ...
     *
     * Left open: whether this reader may see the post at all is a question
     * about the post, not about the shape of the request, and the policy
     * answers it in the controller.
     */
